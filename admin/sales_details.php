                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="details">
                            <table class="table datatable-button-html5-basic table-hover table-bordered   dataTable no-footer">
                                <tr>
                                    <td>PO#</td>
                                    <td style="text-align: center;font-weight: bold"><?= $po_no ?></td>
                                </tr>
                                <tr>
                                    <td>Employee</td>
                                ...
                                <tr>
                                    <td>Discount</td>
                                    <td style="text-align: right;font-weight: bold"><?= number_format($discount, 2) ?></td>
                                </tr>
                                <?php if ($sales_type == 0) { ?>
                                    <td>Other Amount</td>
                                    <td style="text-align: right;font-weight: bold"><?= number_format($other_amount, 2) ?></td>
                                <?php } ?>
                                <!--  <tr>
                                ...
                                <tr>
                                    <td>Cash</td>
                                    <td style="text-align: right;font-weight: bold"><?= number_format($amount_paid, 2) ?></td>
                                </tr>
                                <tr>
                                    <td>Change</td>
                                    <td style="text-align: right;font-weight: bold"><?= number_format($amount_paid - $total_amount > 0 ? $amount_paid - $total_amount : 0, 2) ?></td>
                                </tr>

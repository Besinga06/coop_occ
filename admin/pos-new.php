...
<!DOCTYPE html>
<html lang="en">
    <!-- Mirrored from seantheme.com/color-admin/admin/html/pos_customer_order.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Nov 2020 02:19:52 GMT -->
    <head>
        <meta charset="utf-8" />
    ...
    <body class="pace-top">
            ...
            <div id="content" class="content p-0">
                <div class="pos pos-customer" id="pos-customer">
                    <div class="pos-menu">
                        <div class="logo">
                            <a href="index.php">
                                <div class="logo-img"><img src="../images/logo-final.png" /></div>
                                <div class="logo-text">KURT Pos</div>
                            </a>
                        </div>
                            ...
                            <div data-scrollbar="true" data-height="100%" data-skip-mobile="true">
                                <ul class="nav nav-tabs">
                                   ...
                                   <?php 
                                    ...
                                    ?>
                                        <li class="nav-item">
                                            <a class="nav-link"  href="#" data-filter="cat-<?= $row['cat_id'];?>">
                                            <i class="fa fa-fw fa-utensils mr-1 ml-n2"></i> <?= $row['category_name'];?>
                                            </a>
                                        </li> 
                                    <?php } ?>
                                </ul>
                        ...
                        <div class="pos-content-container" data-scrollbar="true" data-height="100%" data-skip-mobile="true">
                            <div class="product-row">
                               <?php 
                                ...
                                ?>
                                    <div class="product-container" data-type="cat-<?= $row['cat_id'];?>">
                                        <a href="#" class="product product-cart"  menu-id="<?= $row['cat_id'];?>" >
                                            <div class="img" style="background-image: url(<?=$image_file?>)"></div>
                                            <div class="text">
                                                <div class="title"><?= $row['menu_name'];?>&reg;</div>
                                                <div class="desc">Quantity: <?= $row['quantity'];?></div>
                                                <div class="price"><?= $currency ?> <?= $row['price'];?></div>
                                            </div>
                                        </a>
                                    </div>
                                <?php } ?>
        ...
        <script src="./assets/js/app.min.js" type="9176aef7e9db61249a454e7e-text/javascript"></script>
        <script src="./assets/js/theme/default.min.js" type="9176aef7e9db61249a454e7e-text/javascript"></script>
        <script src="./assets/js/demo/pos-customer-order.demo.js" type="9176aef7e9db61249a454e7e-text/javascript"></script>
        <script src="./assets/js/rocket-loader.min.js" data-cf-settings="9176aef7e9db61249a454e7e-|49" defer=""></script>
        <script type="text/javascript" src="../js/pos-new.js"></script>
    </body>
    <!-- Mirrored from seantheme.com/color-admin/admin/html/pos_customer_order.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Nov 2020 02:19:56 GMT -->
</html>
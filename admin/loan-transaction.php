...
");
            ...
            <div class="modal-content">
                <form id="loanPaymentForm">
                    ...
                    <div class="modal-header bg-teal-400 text-white">
                        ...
                        <h5><i class="icon-add"></i> Add Loan Payment</h5>
                    </div>
                    ...
                    <div class="modal-bodys">
                        ...
                        <div id="loan_schedule_section" style="display:none;">
                            ...
                            <!-- <input type="hidden" id="total_due" value="0"> -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="amount_paid" id="amount_paid" class="form-control" required readonly>
                            </div>
                        </div>
    ...
    <script>
        ...
        // Update amount_paid based on payment type
        // Update amount_paid based on payment type

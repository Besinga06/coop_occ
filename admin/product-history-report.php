					...
					<div class="breadcrumb-line">
						...
						<ul class="breadcrumb-elements">
						    ...
						    <li  data-toggle="tooltip" title="Products" style="padding-top: 2px;padding-right: 2px">
						    	<div class="btn-group">
			                        <input autocomplete="off" type="hidden" value="<?php if (isset($_SESSION['inventory-report-product'])!="") { echo  $_SESSION['inventory-report-product']; } ?>" name="user_id" id="user_id">
								    <input style="width: 350px" autocomplete="off" type="search" class="form-control" id="user-input"  value="<?php if (isset($_SESSION['inventory-report-product'])!="") { echo  $selected_product; } ?>" name="username" >

				...
				<div class="content">
					<div class="panel panel-white border-top-xlg border-top-teal-400">
						...
						<div class="panel-body product-div2">
							...
							<?php if ($i==0) {?>
								<tr>
									<td colspan="11" align="center"><h2>No data found!</h2></td>
								</tr>
							<?php }?>
						</table>
						</div>
...
{  
    ...
    $.ajax({
           type      :      'POST',
           url       :      '../transaction.php',
           data      :       {user_sales_details:"",user_id:user_id},
            success  :       function(msg)     
            { 
...
{   var sales_no = $(el).attr('sales_no'); 
    $("#spinner_div").fadeIn(); 
	 $.ajax({
           type      :      'POST',
           url       :      '../transaction.php',
           data      :       {update_sales:"",sales_no:sales_no},
            success  :       function(msg)     
            {  
...
{   
    $("#delete_sale").attr('disabled', true);
	 $.ajax({
        type      :      'GET',
        url       :      '../transaction.php',
        data      :       {delete_sales:"",sales_id:$("#sales-id-input").val()},
        success  :       function(msg)     
        {   console.log(msg);
...
function active_sale()
{
	$("#active_sale").attr('disabled', true);
	 $.ajax({
        type      :      'GET',
        url       :      '../transaction.php',
        data      :       {active_sales:"",sales_id:$("#sales-id-input2").val()},
        success  :       function(msg)     
        {    console.log(msg);

				...
				<div class="row input-div">
					<div class="col-md-4">
						<div class="form-group has-feedback has-feedback-left input-text">
							<input value="<?php if (!empty($_SESSION['pos-customer'])) {
	...
	<div class="row middle-row">
		<div class="col-md-9 no-padding">
				...
				<table class="table-head-cart">
					<thead>
						<tr>
							...
							<th style="text-align: Center ;width: 120px;">&nbsp;&nbsp;&nbsp; Unit</th>
			...
			<div style="width: 100%;text-align: center;padding-top: 6px;color: #fff">
				<p> <a style="text-decoration: none;color: #fff" href="https://www.facebook.com/cesar.besinga.6" target="_blank">Cesar Paje Besinga</a></p>
			</div>
		</div>
		<div class="col-md-3 middle-div no-padding">
			<div align="center">
				<h4 style="color: #fff">#0000000000<span id="sales-no"></span></h4>
			</div>

					...
					<div class="breadcrumb-line">
						...
						<ul class="breadcrumb-elements">
						    ...
						    <li data-toggle="tooltip" title="Supplier" style="padding-top: 2px;padding-right: 2px">
			                    <div class="btn-group">
			                        <input autocomplete="off" type="hidden" value="<?php if (isset($_SESSION['receiving-report-customer'])!="") { echo  $_SESSION['receiving-report-customer']; } ?>" name="cust_id" id="cust_id">
								    <input  autocomplete="off" type="search" class="form-control" id="customer-input" value="<?php if (isset($_SESSION['receiving-report-customer'])!="") { echo  $selected_customer; } ?>" name="custname" >
						    ...
						    <li  data-toggle="tooltip" title="Employee" style="padding-top: 2px;padding-right: 2px">
						    	<div class="btn-group">
			                        <input autocomplete="off" type="hidden" value="<?php if (isset($_SESSION['receiving-report-user'])!="") { echo  $_SESSION['receiving-report-user']; } ?>" name="user_id" id="user_id">
								    <input  autocomplete="off" type="search" class="form-control" id="user-input"  value="<?php if (isset($_SESSION['receiving-report-user'])!="") { echo  $selected_user; } ?>" name="username" >
